...
def main():
    ...
    DEFAULTS = {
        ...
        "output_dir": str(REPO_ROOT / "data" / "gloss_clips"),
        "manifest":   str(REPO_ROOT / "data" / "manifests" / "gloss_clips_manifest.xlsx"),
        "excel":      str(REPO_ROOT / "data" / "manifests" / "Auslan-Daily_Communication_with_gloss_fixed_v2.xlsx"),
        "port":       5000,
    }
    # ─────────────────────────────────────────────────────────────────────────
